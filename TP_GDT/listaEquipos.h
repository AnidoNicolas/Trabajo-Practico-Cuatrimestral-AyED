...
typedef Equipo DatoEquipo;

/* Tipo de Estructura de los Nodos de la Lista. */
struct NodoListaEquipo {
    DatoEquipo dato; // dato almacenado
    NodoListaEquipo* sgte; // puntero al siguiente
};
...
struct ListaEquipo{
    PtrNodoListaEquipo primeroEquipo;      // puntero al primer nodo de la lista
};
